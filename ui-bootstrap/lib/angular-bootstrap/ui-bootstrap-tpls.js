...
/**
 * The $uibTooltip service creates tooltip- and popover-like directives as well as
...
.provider('$uibTooltip', function() {
   ...
   * application.
   *
   *   var app = angular.module( 'App', ['ui.bootstrap.tooltip'], function( $uibTooltipProvider ) {
  ...
  /**
   * Returns the actual instance of the $uibTooltip service.
   * TODO support multiple triggers
   */
  this.$get = ['$window', '$compile', '$timeout', '$document', '$position', '$interpolate', '$rootScope', '$parse', function($window, $compile, $timeout, $document, $position, $interpolate, $rootScope, $parse) {
    return function $uibTooltip(type, prefix, defaultTriggerShow, options) {
       ...
       * option passed to the `$uibTooltipProvider.options` method; else it will
       * default to the trigger supplied to this directive factory.
       *
       * The hide trigger is based on the show trigger. If the `trigger` option
       * was passed to the `$uibTooltipProvider.options` method, it will use the
...
.directive('tooltipTemplate', ['$uibTooltip', function($uibTooltip) {
...
.directive('tooltipHtml', ['$uibTooltip', function($uibTooltip) {
...
.directive('tooltipHtmlUnsafe', [
          '$uibTooltip', 'tooltipHtmlUnsafeSuppressDeprecated', '$log',
function($uibTooltip ,  tooltipHtmlUnsafeSuppressDeprecated ,  $log) {
  if (!tooltipHtmlUnsafeSuppressDeprecated) {
    $log.warn('tooltip-html-unsafe is now deprecated. Use tooltip-html or tooltip-template instead.');
  }
  return $uibTooltip('tooltipHtmlUnsafe', 'tooltip', 'mouseenter');
}]);
...
.directive('popoverTemplate', ['$uibTooltip', function($uibTooltip) {
...
.directive('popoverHtml', ['$uibTooltip', function($uibTooltip) {
...
.directive('popover', ['$uibTooltip', function($uibTooltip) {
...
angular.module("template/carousel/carousel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/carousel/carousel.html",
    ...
    "    <a class=\"left carousel-control\" ng-click=\"prev()\" ng-show=\"slides.length > 1\"><span class=\"left-scroll-pic\"></span></a>\n" +
    "    <a class=\"right carousel-control\" ng-click=\"next()\" ng-show=\"slides.length > 1\"><span class=\"right-scroll-pic\"></span></a>\n" +
    "</div>\n" +
    "");
}]);
